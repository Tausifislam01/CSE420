...
public:
    ...
    string generate_code(ofstream& outcode, map<string, string>& symbol_to_temp,
        ...
        string temp = "t" + to_string(temp_count++);
        outcode << temp << " = " << left_temp << " " << op << " " << right_temp << "\n";
        return temp;
    }
};
...
public:
    ...
    string generate_code(ofstream& outcode, map<string, string>& symbol_to_temp,
        ...
        string temp;
        for (auto stmt : statements) {
            temp = stmt->generate_code(outcode, symbol_to_temp, temp_count, label_count);
        }
        return temp;
    }
};
...
public:
    ...
    string generate_code(ofstream& outcode, map<string, string>& symbol_to_temp,
        ...
        string temp = "t" + to_string(temp_count++);
        outcode << temp << " = call " << func_name << ", " << arg_temps.size() << "\n";
        return temp;
    }
};
