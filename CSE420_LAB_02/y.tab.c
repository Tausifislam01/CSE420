...
{
       0,    58,    58,    65,    71,    79,    85,    93,    93,   116,
     116,   134,   145,   157,   170,   183,   183,   209,   209,   227,
     244,   252,   260,   270,   287,   306,   324,   346,   352,   361,
     368,   376,   383,   390,   397,   404,   411,   418,   425,   434,
     441,   450,   458,   467,   474,   483,   490,   499,   506,   515,
     523,   532,   540,   550,   557,   564,   573,   580,   587,   594,
     601,   608,   615,   624,   632,   640,   647
};
#endif
...
#line 93 "21201535.y"
    {
			...
			if(!func_exist_check((yyvsp[(2) - (5)])->getname())) {
				vector<pair<string, string> > params = cur_funct_parameter;
				symbol_info* funct = new symbol_info((yyvsp[(2) - (5)])->getname(), "ID", (yyvsp[(1) - (5)])->getname());
				funct->set_as_function((yyvsp[(1) - (5)])->getname(), params);
				table->insert(funct);
			}
...
#line 116 "21201535.y"
    {
			...
			if(!func_exist_check((yyvsp[(2) - (4)])->getname())) {
				vector<pair<string, string> > params;
				symbol_info* funct = new symbol_info((yyvsp[(2) - (4)])->getname(), "ID", (yyvsp[(1) - (4)])->getname());
				funct->set_as_function((yyvsp[(1) - (4)])->getname(), params);
				table->insert(funct);
			}
...
#line 135 "21201535.y"
    {
			...
			pair<string, string> parameter((yyvsp[(3) - (4)])->getname(), (yyvsp[(4) - (4)])->getname());
...
#line 146 "21201535.y"
    {
			...
			pair<string, string> parameter((yyvsp[(3) - (3)])->getname(), "");
			cur_funct_parameter.push_back(parameter);
		}
    break;
...
#line 158 "21201535.y"
    {
			...
			pair<string, string> parameter((yyvsp[(1) - (2)])->getname(), (yyvsp[(2) - (2)])->getname());
			cur_funct_parameter.push_back(parameter);
		}
    break;
...
#line 171 "21201535.y"
    {
			...
			pair<string, string> parameter((yyvsp[(1) - (1)])->getname(), "");
			cur_funct_parameter.push_back(parameter);
		}
    break;
...
#line 271 "21201535.y"
    {
            ...
            if(var_exist_check((yyvsp[(3) - (3)])->getname())) {
...
#line 288 "21201535.y"
    {
            ...
            if(var_exist_check((yyvsp[(3) - (6)])->getname())) {
...
#line 307 "21201535.y"
    {
            ...
            if(var_exist_check((yyvsp[(1) - (1)])->getname())) {
...
#line 325 "21201535.y"
    {
            ...
            if(var_exist_check((yyvsp[(1) - (4)])->getname())) {
